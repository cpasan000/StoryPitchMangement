...
update stories set submission_date = '2023-06-18';
update stories set submission_date = '2023-06-04' where id = 3;
update stories set assistant = null, editor = null;
update stories set requestor_name = 'Alex Luna' where id = 3;
